## code to prepare `ewe_ecosim_base_nwatlantic` dataset goes here
# This script prepares the `ewe_ecosim_base_nwatlantic` dataset.
# This dataset is an Ecopath with Ecosim (EwE) model for the Northwest Atlantic.
# The raw data for this model is stored in the
# `inst/extdata/ewe_ecosim_base_nwatlantic` directory.
...
# `usethis::use_data` saves the `ewe_ecosim_base_nwatlantic` object into the
...
usethis::use_data(ewe_ecosim_base_nwatlantic, overwrite = TRUE)
