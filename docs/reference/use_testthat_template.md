...
- name:
  ...
  A string providing the name of the R function that you want to test.
...
by this function. The first states where the ecosystemom project is on
your computer. The second states the file path of the newly created
file. The file will not be automatically opened.

## Details

There are three minimum testing criteria for ecosystemom, which should
be validated for every R function within the package. The template file
