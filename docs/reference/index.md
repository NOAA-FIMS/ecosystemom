...
- [`calc_truth()`](calc_truth.md) : Calculate "truth" for a species
  using ecosystem model outputs
- [`calc_truth_agecomp_monthly()`](calc_truth_agecomp_monthly.md) :
  Calculate "true" monthly age composition for a species
- [`calc_truth_agecomp_yearly()`](calc_truth_agecomp_yearly.md) :
  Calculate "true" yearly age composition for a species
- [`calc_truth_index_monthly()`](calc_truth_index_monthly.md) :
  Calculate "true" monthly index for a species
- [`calc_truth_index_yearly()`](calc_truth_index_yearly.md) : Calculate
  "true" yearly index for a species
- [`calc_truth_monthly()`](calc_truth_monthly.md) : Calculate monthly
  "truth" for a species
