...
- Most parameters, including fleet selectivity parameters, initial numbers-at-age (`log_init_naa`), time-varying natural mortality (`log_M`), and maturity parameters, were fixed at their initial values derived from the OM. 
- Stock-recruit steepness (`logit_steep`) and recruitment variance (`log_sd`) were fixed at the values from the Beaufort Assessment Model rather than estimated.
