...
pak::pak(
  c(
    "NOAA-FIMS/FIMS@main-lexical-error-in-json",
    "NOAA-FIMS/FIMSdiags",
    "nmfs-ost/stockplotr",
...
selectivity_inflection_point <- 1.5   # Fully mature/available by age 3
selectivity_slope <- 2.0   # A distinct, clean gradient
